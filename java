 ...
 */
package suma.entre.pkg1.y.pkg99;

/**
 *
 * @author Usuario
 */
public class SumaEntre1Y99 {
    public static void main(String[] args) {
double a1,b1,c1,d1,e1,f1,g1,h1,pi=3.1416;
     ...
     System.out.println("el resultado de la operacion es: "+b1);
